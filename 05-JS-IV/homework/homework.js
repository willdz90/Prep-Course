...
function tienePropiedad(objeto, propiedad) {
  ...
  // Tu código:
  const propertys = Object.keys(objeto)
  for(prop in propertys){
    if(propertys[prop] === propiedad) return true;
  }
  return false
}
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  // Tu código:
  producto.calcularPrecioDescuento = () =>{return producto.precio - producto.precio * producto.porcentajeDeDescuento};
  return producto
}
